      ...
      <div key={attributeId} className="attribute">
        ...
        <div className="attribute-options">
          {items && items.map((item) => {
            ...
            const isSelectedSwatchAttribute = (selectedValue && itemId === valueId)
              ? 'attribute-option swatch selected'
            ...
            const isSelectedSwatch = (
              <span
                ...
                onClick={selectingEnabled
                  ...
                  : null}
                className={inStock
                  ? isSelectedSwatchAttribute
                  : 'attribute-option swatch opacity'}
              />
            );

            const isSelectedTextAttribute = (selectedValue && itemId === valueId)
            ...
            const isSelectedText = (
              <span
                ...
                onClick={selectingEnabled
                  ? () => selectAttribute({ id: attributeId, item })
                  : null}
                className={inStock ? isSelectedTextAttribute : 'attribute-option text out-of-stock'}
              >
                {value}
              </span>
            );
